...
# echo "</center>" >> $output
paypal='<svg class="icon icon-logo-paypal">
          <use xlink:href="#icon-logo-paypal">
...

{
  ...
  echo "<div class='support'><h1>Mich unterst&uuml;tzen! 	&#128154;</h1></div>"
  echo "<div class='support-text'><p>
    Hat dich diese Website nach <bold>Cookies</bold> gefragt?<br>
    Hast du irgendwo <bold>Werbung</bold> gesehen?<br>
    Nein?<br>
    Diese Privilegien biete ich kostenlos an.<br>
    Keine Werbung und kein Tracking von dem was du auf dieser Website machst.<br>
    Das bedeutet f&uuml;r mich jedoch Kosten, die ich alleine bezahlen muss.<br>
    Wenn du mir dabei helfen willst, kannst du gerne etwas Geld spenden.</p>
    <div>
      <a href='https://www.paypal.me/timotheus4910' target='_blank'>$paypal</a>
    </div>
  </div>"
  echo "<h4 class='footer' style='text-align: center'>
          <a href='https://github.com/timitoerner/fsm.timitoerner.org' target='_blank'>Source Code</a> 
          <a href='https://fsm.timitoerner.org/impressum.png' target='_blank'>Impressum</a></h4>"
  echo "</body>"
  echo "</html>"
} >> $output
